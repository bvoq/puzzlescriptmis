...
namespace msa {
    ...
    public:
        ...
        void loop_end() {
            ...
            if(verbose) {
                cout << iterations << ": ";
                cout << "run_duration: " << run_duration.count() << ", ";
                cout << "current_loop_duration: " << current_loop_duration.count() << ", ";
                cout << "avg_loop_duration: " << avg_loop_duration.count() << ", ";
                cout << std::endl;
            }
        }
        ...
        static void test(unsigned int max_millis) {
            ...
            cout << "total run time: " << timer.run_duration_micros() << ", ";
            cout << "avg_loop_duration: " << timer.avg_loop_duration_micros() << ", ";
            cout << std::endl;
        }
